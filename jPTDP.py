...
if __name__ == '__main__':
    ...
    parser.add_option("--morph_soft_embed", action="store_true", dest="morph_soft_embed", default=False)
    parser.add_option("--pos_soft_embed", action="store_true", dest="pos_soft_embed", default=False)    
